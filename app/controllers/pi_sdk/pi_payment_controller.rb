...
require 'uri'
require 'json'
#require_relative '../../models/pi_sdk/user_d_t_o'
#require_relative '../../models/pi_sdk/payment_d_t_o'
...
module PiSdk
  ...
  class PiPaymentController < ApplicationController
    ...
    def approve
      ...
      user_dto = ::PiSdk::UserDTO.get(access_token)
      unless user_dto
    ...
    def complete
      ...
      payment = ::PiSdk::PaymentDTO.get(payment_id)
      unless payment
